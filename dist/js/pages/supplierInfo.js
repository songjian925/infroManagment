...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='supplierInfo.html';
});
...
function checkInfo(obj){
    ...
    $('#check_supplierID').val(tds.eq(0).text());
    $('#check_supplierName').val(tds.eq(1).text());
    $('#check_supplierAddress').val(tds.eq(2).text());
    $("#check_supplierAcount").val(tds.eq(3).text());
    $('#check_contact').val(tds.eq(4).text());
    $('#check_contactPhone').val(tds.eq(5).text());
...
function updateInfo(obj){
    ...
    $('#update_supplierID').val(tds.eq(0).text());
    $('#update_supplierName').val(tds.eq(1).text());
    $('#update_supplierAddress').val(tds.eq(2).text());
    $("#update_supplierAcount").val(tds.eq(3).text());
    $('#update_contact').val(tds.eq(4).text());
    $('#update_contactPhone').val(tds.eq(5).text());
    $('#updateSupplier').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_supplierID').val(tds.eq(0).text());
