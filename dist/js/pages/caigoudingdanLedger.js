...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='caigoudingdanLedger.html';
});
...
function checkInfo(obj){
    ...
    $('#check_dingdanID').val(tds.eq(0).text());
    $('#check_wuliaoID').val(tds.eq(1).text());
    $('#check_wuliaoName').val(tds.eq(2).text());
    $("#check_unitPrice").val(tds.eq(3).text());
    $('#check_number').val(tds.eq(4).text());
    $('#check_totalPrice').val(tds.eq(5).text());
    $('#check_contractID').val(tds.eq(6).text());
    $('#check_gongyingshang').val(tds.eq(7).text());
    $('#check_zhixingqingkuang').val(tds.eq(8).text());
    $('#checkCaigoudingdanLedger').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_dingdanID').val(tds.eq(0).text());
    $('#update_wuliaoID').val(tds.eq(1).text());
    $('#update_wuliaoName').val(tds.eq(2).text());
    $("#update_unitPrice").val(tds.eq(3).text());
    $('#update_number').val(tds.eq(4).text());
    $('#update_totalPrice').val(tds.eq(5).text());
    $('#update_contractID').val(tds.eq(6).text());
    $('#update_gongyingshang').val(tds.eq(7).text());
    $('#update_zhixingqingkuang').val(tds.eq(8).text());
    $('#updateCaigoudingdanLedger').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_dingdanID').val(tds.eq(0).text());
    $('#deleteCaigoudingdanLedger').modal('show');
}