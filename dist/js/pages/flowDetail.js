...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='flowDetail.html';
});
...
function checkInfo(obj){
    ...
    $('#check_materialID').val(tds.eq(0).text());
    $('#check_projectID').val(tds.eq(1).text());
    $('#check_flowID').val(tds.eq(2).text());
    $("#check_materiaName").val(tds.eq(3).text());
    $('#check_stockOutNum').val(tds.eq(4).text());
    $('#check_stockOutDate').val(tds.eq(5).text());
    $('#check_stockOutDate1').val(tds.eq(6).text());
    $('#check_locator').val(tds.eq(7).text());
    $('#check_stockOutNum1').val(tds.eq(8).text());
    $("#check_stockOutNum2").val(tds.eq(9).text());
    $('#checkFlowDetail').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_materialID').val(tds.eq(0).text());
    $('#update_projectID').val(tds.eq(1).text());
    $('#update_flowID').val(tds.eq(2).text());
    $("#update_materiaName").val(tds.eq(3).text());
    $('#update_stockOutNum').val(tds.eq(4).text());
    $('#update_stockOutDate').val(tds.eq(5).text());
    $('#update_stockOutDate1').val(tds.eq(6).text());
    $('#update_locator').val(tds.eq(7).text());
    $('#update_stockOutNum1').val(tds.eq(8).text());
    $("#update_stockOutNum2").val(tds.eq(9).text());
    $('#updateFlowDetail').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_materialID').val(tds.eq(0).text());
    $('#deleteFlowDetail').modal('show');
}