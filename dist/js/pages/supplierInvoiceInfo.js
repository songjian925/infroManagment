...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='supplierInvoiceInfo.html';
});
...
function checkInfo(obj){
    ...
    $('#check_invoiceID').val(tds.eq(0).text());
    $('#check_contractID').val(tds.eq(1).text());
    $('#check_dueDate').val(tds.eq(2).text());
    $("#check_pickNum").val(tds.eq(3).text());
    $('#check_pickDate').val(tds.eq(4).text());
    $('#check_getMoney').val(tds.eq(5).text());
    $('#checkSupplierInvoice').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_invoiceID').val(tds.eq(0).text());
    $('#update_contractID').val(tds.eq(1).text());
    $('#update_dueDate').val(tds.eq(2).text());
    $("#update_pickNum").val(tds.eq(3).text());
    $('#update_pickDate').val(tds.eq(4).text());
    $('#update_getMoney').val(tds.eq(5).text());
    $('#updateSupplierInvoice').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_invoiceID').val(tds.eq(0).text());
    $('#deleteSupplierInvoice').modal('show');
}