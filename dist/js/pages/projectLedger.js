...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='projectLedger.html';
});
...
function checkInfo(obj){
    ...
    $('#check_outNum').val(tds.eq(2).text());
    $("#check_inNum").val(tds.eq(3).text());
    $('#check_startDate').val(tds.eq(4).text());
    $('#check_endDate').val(tds.eq(5).text());
    $('#checkStatistics').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_outNum').val(tds.eq(2).text());
    $("#update_inNum").val(tds.eq(3).text());
    $('#update_startDate').val(tds.eq(4).text());
    $('#update_endDate').val(tds.eq(5).text());
    $('#updateStatistics').modal('show');
}
