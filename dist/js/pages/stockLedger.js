...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='stockLedger.html';
});
...
function checkInfo(obj){
    ...
    $('#check_materiaName').val(tds.eq(1).text());
    $('#check_startNum').val(tds.eq(2).text());
    $("#check_changeNum").val(tds.eq(3).text());
    $('#check_endNum').val(tds.eq(4).text());
    $('#check_locator').val(tds.eq(5).text());
    $('#checkStockLedger').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_materiaName').val(tds.eq(1).text());
    $('#update_startNum').val(tds.eq(2).text());
    $("#update_changeNum").val(tds.eq(3).text());
    $('#update_endNum').val(tds.eq(4).text());
    $('#update_locator').val(tds.eq(5).text());
    $('#updateStockLedger').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_materialID').val(tds.eq(0).text());
    $('#deleteStockLedger').modal('show');
}