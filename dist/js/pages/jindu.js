...
function checkInfo(obj){
    ...
    $("#check_totalTime").val(tds.eq(3).text());
    $('#check_jihuayingdaogongqi').val(tds.eq(4).text());
    $('#check_shijiyidaogongqi').val(tds.eq(5).text());
    $('#check_jiezhiriqi').val(tds.eq(6).text());
    $('#checkJindu').modal('show');
}
...
function updateInfo(obj){
    ...
    $("#update_totalTime").val(tds.eq(3).text());
    $('#update_jihuayingdaogongqi').val(tds.eq(4).text());
