...
function checkInfo(obj){
    ...
    $('#check_clientID').val(tds.eq(0).text());
    $('#check_clientName').val(tds.eq(1).text());
    $('#check_clientAddress').val(tds.eq(2).text());
    $("#check_clientAcount").val(tds.eq(3).text());
...
function updateInfo(obj){
    ...
    $('#update_clientID').val(tds.eq(0).text());
    $('#update_clientName').val(tds.eq(1).text());
    $('#update_clientAddress').val(tds.eq(2).text());
    $("#update_clientAcount").val(tds.eq(3).text());
...
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_clientID').val(tds.eq(0).text());
