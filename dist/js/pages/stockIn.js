...
function checkInfo(obj){
    ...
    $("#check_stockInNum").val(tds.eq(3).text());
    $('#check_stockInDate').val(tds.eq(4).text());
...
function updateInfo(obj){
    ...
    $("#update_stockInNum").val(tds.eq(3).text());
    $('#update_stockInDate').val(tds.eq(4).text());
    $('#update_locator').val(tds.eq(5).text());
    $('#updateStockIn').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_materialID').val(tds.eq(0).text());
    $('#deleteStockIn').modal('show');
}