...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='tongjibiao.html';
});
...
function checkInfo(obj){
    ...
    $('#check_projectID').val(tds.eq(0).text());
    $('#check_caigouzonge').val(tds.eq(1).text());
    $('#check_jiezhishijian').val(tds.eq(2).text());
    $('#checkTongjibiao').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_projectID').val(tds.eq(0).text());
    $('#update_jiezhishijian').val(tds.eq(1).text());
    $('#update_jiezhishijian').val(tds.eq(2).text());
    $('#updateTongjibiao').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_projectID').val(tds.eq(0).text());
    $('#deleteTongjibiao').modal('show');
}