...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='jingfeizhichu.html';
});
...
function checkInfo(obj){
    ...
    $("#check_totalGuanli").val(tds.eq(3).text());
    $('#check_totalCaigou').val(tds.eq(4).text());
    $('#check_totalWaixie').val(tds.eq(5).text());
    $('#checkJingfeizhichu').modal('show');
}
...
function updateInfo(obj){
    ...
    $("#update_totalGuanli").val(tds.eq(3).text());
    $('#update_totalCaigou').val(tds.eq(4).text());
    $('#update_totalWaixie').val(tds.eq(5).text());
    $('#updateJingfeizhichu').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_contractID').val(tds.eq(0).text());
    $('#deleteJingfeizhichu').modal('show');
}