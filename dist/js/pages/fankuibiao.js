...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='fankuibiao.html';
});
...
function checkInfo(obj){
    ...
    $('#check_contractID').val(tds.eq(3).text());
    $('#check_gongyingshang').val(tds.eq(4).text());
    $('#check_zhixingqingkuang').val(tds.eq(5).text());
    $('#checkFankuibiao').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_contractID').val(tds.eq(3).text());
    $('#update_gongyingshang').val(tds.eq(4).text());
    $('#update_zhixingqingkuang').val(tds.eq(5).text());
    $('#updateFankuibiao').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_dingdanID').val(tds.eq(0).text());
    $('#deleteFankuibiao').modal('show');
}