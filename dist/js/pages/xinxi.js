...
function checkInfo(obj){
    ...
    $('#check_totalMoney').val(tds.eq(2).text());
    $("#check_shidaokuan").val(tds.eq(3).text());
    $('#check_zonggongqi').val(tds.eq(4).text());
    $('#check_shijiyidaogongqi').val(tds.eq(5).text());
    $('#check_jiezhiriqi').val(tds.eq(6).text());
    $('#checkXinxi').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_totalMoney').val(tds.eq(2).text());
    $("#update_shidaokuan").val(tds.eq(3).text());
    $('#update_zonggongqi').val(tds.eq(4).text());
    $('#update_shijiyidaogongqi').val(tds.eq(5).text());
    $('#update_jiezhiriqi').val(tds.eq(6).text());
    $('#updateXinxi').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_contractID').val(tds.eq(0).text());
    $('#deleteXinxi').modal('show');
}