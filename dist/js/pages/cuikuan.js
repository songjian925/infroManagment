...
$("#btn_add").click(function() {
    ...
    */
    window.location.href='cuikuan.html';
});
...
function checkInfo(obj){
    ...
    $('#check_jihuayingdaokuanqi').val(tds.eq(4).text());
    $('#check_jihuayingdaokuan').val(tds.eq(5).text());
    $('#check_shidaokuan').val(tds.eq(6).text());
    $('#checkCuikuan').modal('show');
}
...
function updateInfo(obj){
    ...
    $('#update_jihuayingdaokuanqi').val(tds.eq(4).text());
    $('#update_jihuayingdaokuan').val(tds.eq(5).text());
    $('#update_shidaokuan').val(tds.eq(6).text());
    $('#updateCuikuan').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_contractID').val(tds.eq(0).text());
    $('#deleteCuikuan').modal('show');
}