...
function checkInfo(obj){
    ...
    $('#check_materiaName').val(tds.eq(2).text());
    $("#check_stockOutNum").val(tds.eq(3).text());
    $('#check_stockOutDate').val(tds.eq(4).text());
...
function updateInfo(obj){
    ...
    $('#update_materiaName').val(tds.eq(2).text());
    $("#update_stockOutNum").val(tds.eq(3).text());
    $('#update_stockOutDate').val(tds.eq(4).text());
    $('#update_locator').val(tds.eq(5).text());
    $('#updateStockOut').modal('show');
}
function deleteInfo(obj){
    var tds=$(obj).parent().parent().find('td');
    $('#delete_materialID').val(tds.eq(0).text());
    $('#deleteStockOut').modal('show');
}